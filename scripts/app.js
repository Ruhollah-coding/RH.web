...
const navBtnTuggle = document.querySelector(".nav__toggle--icon")
const menuIcontoggle = document.querySelector(".menu")
const cover = document.querySelector(".cover")
const resumeListItems = document.querySelectorAll(".resume-list__item")
const portfolioListItems = document.querySelectorAll(".portfolio-list__item")
const menuItems = document.querySelectorAll(".menu__item")
const sections = document.querySelectorAll("main > section")
const changThemeBTN = document.querySelector(".change__theme")
...
if (window.localStorage.getItem("theme") == "dark-theme") {
    ...
    changThemeBTN.innerHTML = lightTheme
}
else if (window.localStorage.getItem("theme") == "light-theme") {
...
// Event Listeners
navBtnTuggle.addEventListener("click", function () {
    this.classList.toggle("nav__toggle--icon--open")
    menuIcontoggle.classList.toggle("menu--open");
    cover.classList.toggle("cover--show")
});
changThemeBTN.addEventListener("click", function () {
...
document.addEventListener("DOMContentLoaded", () => {
    const sections = document.querySelectorAll("section"); // Ensure this selects the correct elements
